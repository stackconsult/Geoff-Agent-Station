...
#[tauri::command]
pub async fn clipboard_set_text(text: String) -> Result<(), String> {
    CLIPBOARD_MANAGER.set_text(text)
}

#[tauri::command]
pub async fn clipboard_get_history() -> Result<Vec<ClipboardEntry>, String> {
    CLIPBOARD_MANAGER.get_history()
}

#[tauri::command]
pub async fn clipboard_search(query: String) -> Result<Vec<ClipboardEntry>, String> {
    CLIPBOARD_MANAGER.search_history(&query)
}

#[tauri::command]
pub async fn clipboard_toggle_favorite(id: String) -> Result<(), String> {
    CLIPBOARD_MANAGER.toggle_favorite(&id)
}

#[tauri::command]
pub async fn clipboard_delete_entry(id: String) -> Result<(), String> {
